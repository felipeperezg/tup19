...
public class main {
	...
	public static void main(String[] args) {
		...
		//Creamos una cuenta default para poder realizar trasnferencias
		do {
			...
			case 4:
				...
				break;
			case 5:
				System.out.println("Cuentas disponibles: "+nuevaCuenta[1].getTitular()+" "+nuevaCuenta[1].getNroCuenta());
				...
				for (int x=0;x<nuevaCuenta.length;x++) {
					if (nuevaCuenta[x].getNroCuenta() == nroCuenta) {
						...
						operacion=sc.nextDouble();
						nuevaCuenta[x].transferirSaldo(nuevaCuenta[0].extraerSaldo(operacion));
						break;
					}
					z=x;
				}
